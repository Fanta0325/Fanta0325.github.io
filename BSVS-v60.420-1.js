...
const SetupMessaging = {
    init() {
        ...
        Armceptor.replace(Libg.offset(0x9B2148), [0x05, 0x00, 0xA0, 0xE3]); // State // v60 sub_9B205C
        Armceptor.ret(Libg.offset(0x9B16E0)); // Messaging::decryptData // v60 sub_9B16E0
