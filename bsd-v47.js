...
// Addresses
const DebuggerFnc = {error: 0x9A1B2C, warning: 0x3D4F56}; // v47.200 | Strings: "[ERROR]", "[warning]"
const HomeScreen_Update_isProd1 = 0x7B3C4D; // v47.200
const HomeScreen_Update_isProd2 = 0x8C4E5F; // v47.200
const InviteFeatureAddr1 = 0xDE5F6A; // v47.200 | CMP #1 | String: "TID_TEAM_NO_MEMBER_INFO"
const ListPopupItemVtableAdr_shared = 0x2A3B4C; // v47.200 | In CountryItem ("country_item") | *a1 = ListPopupItemVtableAdr_shared
const LogicVersion_isProdAddr = 0x1B2C3D; // v47.200 | String: "game.brawlstarsgame.com", function if check, return 1
const PopupVtableAdr_shared = 0x3E4F5A; // v47.200 | In PlayerCountryPopup ("country_popup") | *a1 = PopupVtableAdr_shared
const RootPathAddr = 0x4F5A6B; // v47.200 | Strings: "save", "update", "cache" | First global variable
const SelectSoloModesInTeam = 0x0; // v47.200
const SettingsScreen_isDeveloperBuildAddr = 0x5A6B7C; // v47.200 | String: "LATENCY TESTS" | If function check
const SettingsScreen_isChinaAddr = 0x6B7C8D; // v47.200 | String: "LATENCY TESTS"
const ShouldShowAPITokenButtonAddr = 0x7C8D9E; // v47.200 | String: "TID_API_TOKEN_SHOW" | Default = 0
const SlowModeAdr = 0x8D9EAF; // v47.200 | In GameMain::update(), speed * 0.25 dependency, byte
const StatusID_LDR = 0x9EAFB0; // v47.200 | Message ID: 14361 | Off: (a1 + 88) in encode
const TeamMemberItem_isOwnSide = 0xAFC0D1; // v47.200 | String: "hidden_hero", v = a7 == 0 check

const GameMain_instanceAddr = 0xB0C1D2; // v47.200 | 1st arg of GameMain::showNativeDialog()
const GUI_instanceAddr = 0xC1D2E3; // v47.200 | 1st arg of GUI::showPopup()
const MessageManager_instanceAddr = 0xD2E3F4; // v47.200 | 1st arg of Messaging::send()
const SoundManager_instanceAddr = 0xE3F405; // v47.200 | 1st arg of any PlaySound function | String: "Buy_gems"
const Stage_instanceAddr = 0xF40516; // v47.200 | In popups

const AntiCheat_guardCallback = 0x051627; // v47.200 | in PiranhaMessage::encode()
const MessageManager_adjustSendPackageFnc = 0x162738; // v47.200 | Message ID: 17338
const MessageManager_sendLoginAttributionAnalyticsEventFnc = 0x273849; // v47.200 | Message ID: 30000
const MessageManager_unbotifySendReportsFnc = 0x38495A; // v47.200 | Message ID: 17337

const CreateGameInstance_Protection = {start: 0x495A6B, end: 0x5A6B7C}; // v47.200 | From AndroidMain::onCreate()
const GameMain_Protection = {start: 0x6B7C8D, end: 0x7C8D9E}; // v47.200 | By GameMain::init() parent function by table
const InputSystem_update_Protection = {start: 0x8D9EAF, end: 0x9EAFB0}; // v47.200 | In GameMain::update()
const LoginMessage_encode_Protection = {start: 0xAFC0D1, end: 0xB0C1D2}; // v47.200 | Message ID: 10101; Encode
const ResourceManager_init_Protection = {start: 0xC1D2E3, end: 0xD2E3F4}; // v47.200 | In GameMain::init()
const FontManager_constructInstance_Protection = {start: 0xE3F405, end: 0xF40516}; // v47.200 | In GameMain::update() | Function with 2 arguments after many checks, first arg is dword
const SoundManager_update_Protection = {start: 0x051627, end: 0x162738}; // v47.200 | In GameMain::update() | Function with 2 arguments after many checks, first arg is dword
...
// Strings
const CreditsProdHostStr = 0x273849; // v47.200 | String: "game.brawlstarsgame.com:9339"
const LaserScreenMaskStr = 0x38495A; // v47.200 | String: "laser_screen_mask"
const LatencyTestsStr = {off: 0x495A6B, dcd: 0x5A6B7C}; // v47.200 | String: "LATENCY TESTS"
const LobbyInfoWithoutPlayersOnlineStr = {off: 0x6B7C8D, dcd: 0x7C8D9E}; // v47.200 | String: "%d-%d%s%s\n%s\n%s"
const LobbyInfoWithPlayersOnlineStr = {off: 0x8D9EAF, dcd: 0x9EAFB0}; // v47.200 | String: "%s\nPlayers online: %i\n%d-%d%s%s\n%s\n%s"
const ShellyMcColtStr = {off: 0xAFC0D1, dcd: 0xB0C1D2}; // v47.200 | String: "\n\nShelly McColt"
const StageHostStr = 0xC1D2E3; // v47.200 | String: "ec2-54-147-16-212.compute-1.amazonaws.com"
const IntegrationHostStr = 0xD2E3F4; // v47.200 | String: "99.80.67.85"
const TidApiTokenShowStr = {off: 0xE3F405, dcd: 0xF40516}; // v47.200 | String: "TID_API_TOKEN_SHOW"
const TidChinaPrivacySettingsButtonStr = {off: 0x051627, dcd: 0x162738}; // v47.200 | String: "TID_CHINA_PRIVACY_SETTINGS_BUTTON"
const TidConnectingToServerStr = {off: 0x273849, dcd: 0x38495A}; // v47.200 | String: "TID_CONNECTING_TO_SERVER"
...
const BrawlPassPopup_buttonClicked = new NativeFunction(base.add(0x3C7EFD), 'void', ['pointer', 'pointer']); // v47.200 | String: "TID_BRAWL_PASS_CANNOT_PURCHASE_BRAWL_PASS_FOR_PAST_SEASON"
const BrawlPassSeasonData_hasUnclaimedRewards = base.add(0xBF8E9D); // v47.200 | BrawlPassPopup::buttonClicked() --> PreviousSeasonButtonPressed --> if current season == actual season check --> 2nd function --> if hasUnclaimedRewards then return
const ChatToAllianceMessage_encode = new NativeFunction(base.add(0x9CD9E1), 'void', ['pointer']); // v47.200 | Message type: 14315, 0x37EB
const CopyString = new NativeFunction(base.add(0xDC9F59), 'void', ['pointer']); // v47.200 | String: "copyString"
const CustomButton_setButtonListener = new NativeFunction(base.add(0x76D051), 'void', ['pointer', 'pointer']); // v47.200 | country popup
const DisplayObject_setY = new NativeFunction(base.add(0x4FBE35), 'void', ['pointer', 'float']); // v47.200 | country popup
const DropGUIContainer_addGameButton = new NativeFunction(base.add(0x860B11), 'pointer', ['pointer', 'pointer', 'int']); // v47.200 | In "popup_craft_gear" or String: "Unable to create GameButton ".. | Only 1 xref (mention) of string
const EmoteIcon_playAnim = new NativeFunction(base.add(0x7B842D), 'void', ['pointer', 'int', 'int', 'float']); // v47.200 | String: "emote_empty_ph", bottom function
const GameButton = new NativeFunction(base.add(0x8FB715), 'void', ['pointer']); // v47.200 | country popup
const GameMain_reloadGame = new NativeFunction(base.add(0x848085), 'void', ['pointer']); // v47.200 | Under GameMain::init()
const GameMain_update = new NativeFunction(base.add(0x3C4DE5), 'void', ['pointer', 'float', 'float']); // v47.200 | Parental function of ServerConnection::update
const GenericPopup = new NativeFunction(base.add(0x341951), 'void', ['pointer', 'pointer', 'int', 'int', 'pointer', 'pointer', 'pointer']); // v47.200 | From CountryPopup
const GenericPopup_buttonClicked = new NativeFunction(base.add(0x6C28D9), 'void', ['pointer', 'pointer']); // v47.200 | coutnry popup button clicked
const GenericPopup_setTitleTid = new NativeFunction(base.add(0x3F498D), 'void', ['pointer', 'pointer']); // v47.200 | country popup
const GenericPopup_setUpScreenHeader = new NativeFunction(base.add(0x2FA0FD), 'void', ['pointer']); // v47.200 | country popup
const GoalList_displayTrackInfo = new NativeFunction(base.add(0x3A70C9), 'void', ['int', 'int', 'pointer', 'pointer', 'int', 'int', 'int']); // v47.200 | String: "TID_XP_INFO_ME", the function below
const GUI_closePopup = new NativeFunction(base.add(0x619425), 'void', ['pointer', 'int']); // v47.200 | String: "TID_NOT_ENOUGH_GEMS_INFO" --> function above 2 buttonClicked alc
const GUI_closeAllPopups = new NativeFunction(base.add(0x79D6E5), 'void', ['pointer']); // v47.200 | Strings: "Select_brawler", "TID_HERO_DISABLED_CURRENTLY_PRINT"; Bottom function
const GUI_showFloaterTextAtDefaultPos = new NativeFunction(base.add(0x3A9B9D), 'void', ['pointer', 'pointer', 'float', 'int']); // v47.200 | String: "TID_MAP_EDITOR_SAVE_ERROR"
const GUI_showPopup = new NativeFunction(base.add(0x73056D), 'void', ['pointer', 'pointer', 'int', 'int', 'int']); // v47.200
const GUIContainer_getMovieClip = new NativeFunction(base.add(0x84F259), 'pointer', ['pointer']); // v47.200
const HashCodeGenerator_toCode = new NativeFunction(base.add(0xB880BD), 'pointer', ['pointer', 'pointer']); // v47.200 | String: "tag_txt"
const HomeScreen_doOfflineGatcha = new NativeFunction(base.add(0x78528D), 'void', ['int', 'pointer', 'pointer']); // v47.200 | String: "emoji_sprout_gg"
const ListContainer = new NativeFunction(base.add(0x2A26AD), 'void', ['pointer', 'pointer', 'int', 'int', 'int', 'pointer', 'pointer', 'pointer']); // v47.200
const ListContainer_addEntry = new NativeFunction(base.add(0x1CC065), 'void', ['pointer', 'pointer']); // v47.200 | country popup refresh
const ListContainer_clearEntries = new NativeFunction(base.add(0xB8D4F5), 'void', ['pointer']); // v47.200 | country popup refresh
const ListContainer_refreshBounds = new NativeFunction(base.add(0x5CEFB5), 'void', ['pointer', 'float']); // v47.200 | country popup refresh
const ListContainer_refreshEntryPositions = new NativeFunction(base.add(0x67F0BD), 'void', ['pointer', 'int', 'float', 'float', 'float', 'int', 'int']); // v47.200 | country popup refresh
const LogicConfData_getIntValue = new NativeFunction(base.add(0x7F4C8D), 'int', ['pointer', 'int', 'int']); // v47.200
const LogicCharacterData_getDefaultSkin = new NativeFunction(base.add(0x6AC885), 'pointer', ['pointer']); // v47.200 | String: "Skin '%s' is a default skin of character '%s', but does not have name ending 'Default'"
const LogicCharacterData_isDisabled = new NativeFunction(base.add(0x392ABC), 'int', ['pointer']); // v47.200 | String: "Skipping issue of %s missing (in %s), since the referred target character '%s' is disabled"
const LogicDailyData_isBrawlPassPremiumUnlocked = new NativeFunction(base.add(0x5D4E4D), 'int', ['pointer']); // v47.200 | String: "TID_HERO_INFO_LOCKED_BP_TIER_OWNED_INFO_SHORT"
const LogicData_getName = new NativeFunction(base.add(0x782415), 'pointer', ['pointer']); // v47.200 | country item
const LogicData_getValueAt = new NativeFunction(base.add(0x40D1D9), 'pointer', ['pointer', 'int']); // v47.200 | In LogicCharacterData::createReferences
const LogicDataTables_getCharacterByName = new NativeFunction(base.add(0xC91011), 'pointer', ['pointer', 'pointer']); // v47.200 | String: "ShotgunGirl"
const LogicDataTables_getSkinByName = new NativeFunction(base.add(0xBB49C5), 'pointer', ['pointer', 'pointer']); // v47.200 | LogicSkinData::createReferences, 3 matches, a2 = a1 of parent
const LogicDataTables_getSkinConfByName = new NativeFunction(base.add(0xB07E55), 'pointer', ['pointer', 'pointer']); // v47.200 | String: "OutlineShader" | a2 is a1 of parent function (CreateReferences)
const LogicDataTables_getSoundByName = new NativeFunction(base.add(0xBC8451), 'pointer', ['pointer', 'int']); // v47.200 | String: "Buy_gems"
const LogicDataTables_getTable = new NativeFunction(base.add(0xCB7391), 'pointer', ['int']); // v47.200 | country popup
const LogicSkinData_createReferences = new NativeFunction(base.add(0xD08DC5), 'void', ['pointer']); // v47.200 | String: "OutlineShader"
const LogicThemeData_isDisabled = new NativeFunction(base.add(0x8FACD9), 'int', ['pointer']); // v47.200 | String: "Active theme is marked disabled! theme: "
const LogicThemeData_getExportName = new NativeFunction(base.add(0x8F4CD1), 'pointer', ['pointer']); // v47.200
const LogicThemeData_getFileName = new NativeFunction(base.add(0x858989), 'pointer', ['pointer']); // v47.200
const LoginOkMessage_decode = new NativeFunction(base.add(0x73B9C5), 'void', ['pointer']); // v47.200 | Message type: 20104
const MapEditorModifierPopup_addModifierItem = new NativeFunction(base.add(0x81C361), 'void', ['pointer', 'int']); // v47.200 | String: "popup_editor_modifier"
const MessageManager_sendMessage = new NativeFunction(base.add(0x882FFD), 'void', ['pointer', 'pointer']); // v47.200
const MovieClip_getTextFieldByName = new NativeFunction(base.add(0xB29275), 'pointer', ['pointer', 'pointer']); // v47.200
const MovieClip_gotoAndStopFrameIndex = new NativeFunction(base.add(0xB85A11), 'void', ['pointer', 'int']); // v47.200 | country item
const MovieClipHelper_setTextAndScaleIfNecessary = new NativeFunction(base.add(0x1BC139), 'void', ['pointer', 'pointer', 'int', 'int']); // v47.200 | country item
const Path_setRootPath = new NativeFunction(base.add(0x30BB39), 'void', ['pointer']); // v47.200 | Strings: "save", "update", "cache"
const PlayerInfo_refreshPlayerHeader = new NativeFunction(base.add(0x5189A9), 'void', ['pointer']); // v47.200 | String: "tag_txt"
const SoundManager_playSound = new NativeFunction(base.add(0x50DD19), 'void', ['pointer', 'pointer', 'float', 'float', 'int', 'float', 'int']); // v47.200 | String: "Buy_gems"
const PopupBase = new NativeFunction(base.add(0xB2C3AD), 'void', ['pointer', 'pointer', 'pointer', 'int', 'int', 'pointer', 'pointer', 'pointer']); // v47.200
const PopupBase_getNaviHeight = new NativeFunction(base.add(0xBA9A91), 'float', ['pointer']); // v47.200 | country popup refresh
const SettingsScreen_buttonClicked = new NativeFunction(base.add(0x909AB1), 'void', ['pointer', 'pointer']); // v47.200 | String: "TID_SETTINGS_WECHAT_NOT_INSTALLED"
const StringTable_getCurrentLanguageCode = new NativeFunction(base.add(0x74E575), 'pointer', []); // v47.200 | String: "TID_ADDITIONAL_GEM_TOOLTIP_FOR_JAPAN"
const StringTable_getMovieClip = new NativeFunction(base.add(0xA4BC39), 'pointer', ['pointer', 'pointer']); // v47.200 | country popup
const StringTable_getString = new NativeFunction(base.add(0x7D8499), 'pointer', ['pointer']); // v47.200 | any TID_ parse
const StringTable_setLanguageIndex = new NativeFunction(base.add(0x95A189), 'void', ['int', 'int']); // v47.200
const TeamChatMessage_encode = new NativeFunction(base.add(0xBA6D99), 'void', ['pointer']); // v47.200 | Message type: 14359, 0x3817
const TeamJoinRequestPopup = new NativeFunction(base.add(0xAAFC29), 'void', ['pointer', 'pointer', 'pointer']); // v47.200 | String: "popup_gameroom_invite"
const TeamInvitationPopup = new NativeFunction(base.add(0xB6171D), 'void', ['pointer', 'pointer', 'int']); // v47.200 | Strings: "popup_gameroom_invite_teams", "popup_gameroom_invite_with_mode"
const TeamMemberStatusMessage = new NativeFunction(base.add(0x884955), 'void', ['pointer', 'int']); // v47.200 | Message ID: 14361 | Parent should have string: "Changed status: "..
const TeamManager_onTeamMessage = new NativeFunction(base.add(0x2F1EBD), 'void', ['pointer', 'pointer']); // v47.200 | String: "Got team: "..
const TeamManager_onTeamLeftMessage = new NativeFunction(base.add(0x5D41D5), 'void', ['pointer', 'pointer']); // v47.200 | String: "TID_TEAM_MEMBER_LEFT_"..
...
const EventDetailsPopup_init = new NativeFunction(base.add(0x3AE7B0), 'void', ['pointer', 'pointer']); // v47.200 | String: "quest_button"
const LocationInfo_getLocationThemeData = new NativeFunction(base.add(0xA17E40), 'pointer', ['pointer']); // v47.200 | String: ""
...
Interceptor.replace(Path_setRootPath, new NativeCallback(function(src) {
    ...
    const LogicThemeData_getThemeMusic = new NativeFunction(base.add(0xD07ED0), 'pointer', ['pointer']); // v47.200 | String: "Theme '%s' is missing music"
...
const LogicLocationData_createReferences = new NativeFunction(base.add(0xA9F0C0), 'void', ['pointer']); // v47.200 | String: "SupportingCampaignGround", parental function
const LogicDataTables_getLocationThemeByName = new NativeFunction(base.add(0x76700C), 'pointer', ['pointer', 'pointer']); // v47.200 | First ptr of LogicLocationData::createReferences
...
const LogicSkillData_hasMovementBasedAutoshoot = new NativeFunction(base.add(0xB5CE48), 'int', ['pointer']); // v47.200
const LogicSkillData_canAutoShoot = new NativeFunction(base.add(0x6683F0), 'int', ['pointer']); // v47.200
...
/*
const LogicProjectileData_createReferences = new NativeFunction(base.add(0xB1F72C), 'void', ['pointer']); // v47.200 | String: "IsBeam", parental function
...
function ModConfigurationPopup(self) {
    const ScrollArea = new NativeFunction(base.add(0x74D4A4), 'void', ['pointer', 'pointer', 'int']); // v47.200
    const ScrollArea_enablePinching = new NativeFunction(base.add(0x579DD4), 'void', ['pointer', 'int']); // v47.200
    const ScrollArea_enableHorizontalDrag = new NativeFunction(base.add(0x5F0CF8), 'void', ['pointer', 'int']); // v47.200
    const ScrollArea_enableVerticalDrag = new NativeFunction(base.add(0xA965D0), 'void', ['pointer', 'int']); // v47.200
    const ScrollArea_setAlignment = new NativeFunction(base.add(0x1521C8), 'void', ['pointer', 'int']); // v47.200
    const Sprite_addChild = new NativeFunction(base.add(0x95DD88), 'void', ['pointer', 'pointer']); // v47.200
    ...
    function ModConfigurationPopup_addItem(self, conf={id: 0, info_object: {}, key: SaveObject.key, icon: "sc/ui.sc:"}) {
        function ModConfigurationItem(self, conf) {
            ...
            let mc2_height = new NativeFunction(base.add(0xAF9B38), 'float', ['pointer'])(mc2); // v47.200
            let mc3_height = new NativeFunction(base.add(0xAF9B38), 'float', ['pointer'])(mc3); // v47.200
            new NativeFunction(base.add(0x2886D4), 'void', ['pointer', 'float'])(mc3, mc2_height / mc3_height); // v47.200
            let mc2_x = new NativeFunction(base.add(0x8E5EAC), 'float', ['pointer'])(mc2); // v47.200
            let mc2_y = new NativeFunction(base.add(0xAFAAB4), 'float', ['pointer'])(mc2); // v47.200
            new NativeFunction(base.add(0x5396B0), 'void', ['pointer', 'float', 'float'])(mc3, mc2_x, mc2_y); // v47.200
            Sprite_addChild(mc1, mc3);
            ClearStringObjects([title, description, s1, s2, s3, s4]);
        }
        const DropGUIContainer = new NativeFunction(base.add(0xA0E2F8), 'void', ['pointer']); // v47.200
        let alc1 = malloc(144);
    ...
    WriteToMemory(self, "Pointer", base.add(0x10C8E10)); // v47.200
...
function ModMenuPopup(a1) {
    function ModMenuPopup_refreshItems(a1) {
        ...
        function OpenBrawlStats() {
            var PlayerTagLogicLong = new NativeFunction(base.add(0x788184), 'pointer', ['pointer'])(base.add(GameMain_instanceAddr).readPointer()); // v47.200 | String: ""
            ...
            const SimpleWebView = new NativeFunction(base.add(0xADA5B4), 'void', ['pointer']); // v47.200
            const SimpleWebView_loadURL = new NativeFunction(base.add(0x59A7CC), 'void', ['pointer', 'pointer']); // v47.200
...
function LocationThemesPopup(self, LocationInfo) {
    ...
    const LogicLocationThemeData_isEnabled = new NativeFunction(base.add(0xC2E47C), 'int', ['pointer']); // v47.200 | String: "Player Map Environment '%s' is enabled, but its location theme data %s at index %d is disabled!"
    const LogicLocationThemeData_getMapWidth = new NativeFunction(base.add(0x1A78D8), 'int', ['pointer']); // v47.200 | String: "Player Map Environment '%s' location theme data at index %d has width %d, required to be %d for game mode variation %d"
    const LogicLocationThemeData_getMapHeight = new NativeFunction(base.add(0x59E2E4), 'int', ['pointer']); // v47.200 | String: "Player Map Environment '%s' location theme data at index %d has height %d, required to be %d for game mode variation %d"
...
const BattleScreen_enter = new NativeFunction(base.add(0x889BBC), 'void', ['pointer']); // v47.200 | String: "land_zone"
...
v42 = (float)v41;
v43 = (float)v37;
v47 = (float)*(int *)(a1 + 0x6F4);
if ( (float)v37 > (float)v41 )
{
  if ( (float)(v42 + 50.0) <= v43 )
    v47 = (float)v40;
  else
    v47 = v47 + (float)((float)((float)(v43 - v42) * 0.02) * (float)((float)v40 - v47));
}
if ( fabsf(v47) > 0.1 )
{
  v55[1] = 0x3F800000;
  v55[2] = 0;
  v55[0] = 0;
  sub_2C3008(v54, v55, LODWORD(v47));
  v45 = nullsub_6(v54);
